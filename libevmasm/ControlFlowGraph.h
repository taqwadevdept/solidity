...
public:
	...
	static BlockId initial() { return BlockId(unsigned(std::numeric_limits<unsigned>::max() - 1)); }
	static BlockId invalid() { return BlockId(unsigned(std::numeric_limits<unsigned>::max())); }
